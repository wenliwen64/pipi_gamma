...
const int bad_Ref_day2[13] = {13703,13800,13802,14005,14107,14301,14307,14600,15901,16304,16407,16705,17005};
...
//	nentries = 50000;
	...
	for(int i = 0; i < nentries; i++){
		...
		Day2    = (int)((Run-12000000)/10);
                ...
                int Bad =0;
                for(int jj=0;jj<13;jj++) if(Day2== bad_Ref_day2[jj]) {Bad = 1;break;}
